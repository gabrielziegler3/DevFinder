...
class AppliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apply" do
    assert_difference('Apply.count') do
      post applies_url, params: { apply: { free_time: @apply.free_time, skills: @apply.skills } }
    end
  ...
  test "should update apply" do
    patch apply_url(@apply), params: { apply: { free_time: @apply.free_time, skills: @apply.skills } }
